...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception{
        http
                ...
                .and()
                .authorizeRequests()
                .antMatchers("/", "/home", "/users/signup", "/signup", "/app/signup", "/signupmessage").permitAll()
                ...
                .antMatchers("/admin", "/companies", "/companyinfo", "/departments", "/layouts", "/roles", "/users", "/currentlist").hasRole("ADMIN")
